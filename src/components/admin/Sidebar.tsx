...
export default function AdminSidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const NAV = [
    {
      label: "CRM",
      items: [
        { href: "/admin",              label: "Pipeline",        icon: "grid",        badge: counts.activeClients || null },
        { href: "/admin/crm/followup", label: "Suivi J+7",       icon: "clock",       badge: counts.overdueFollowups || null, badgeRed: true },
    ...
    },
    {
      ...
      items: [
        ...
        { href: "/admin/billing/recovery", label: "Recouvrement",    icon: "credit-card", badge: counts.recoveryClients || null, badgeRed: true },
      ],
    },
    {
      label: "Réseaux sociaux",
      items: [
        { href: "/admin/social",       label: "Calendrier éditorial", icon: "calendar", badge: counts.scheduledPosts || null },
    ...
    },
    {
      label: "Paramètres",
      items: [
        { href: "/admin/settings/users", label: "Utilisateurs", icon: "user-plus" },
        { href: "/admin/settings/roles", label: "Rôles",         icon: "shield" },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      <aside className={`
        fixed inset-y-0 left-0 z-50 w-[240px] flex-shrink-0 bg-[var(--color-g-900)] flex flex-col overflow-y-auto
      ...
      `}>
        ...
        <div className="px-5 py-6 border-b border-white/7 flex items-center gap-3">
          ...
          <button
            onClick={onClose}
            className="ml-auto text-white/40 hover:text-white/70 lg:hidden"
          >
